...
import com.example.javadesignpattern.strategy.Hand;
import com.example.javadesignpattern.strategy.Player;
import com.example.javadesignpattern.strategy.ProbStrategy;
import com.example.javadesignpattern.strategy.WinningStrategy;
...
public class ExampleUnitTest {
    ...
    @Test
    public void strategyRockScissorsPaper() {
        Player player1 = new Player("두리", new WinningStrategy(314));
        Player player2 = new Player("하나", new ProbStrategy(15));
